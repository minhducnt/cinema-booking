...
const BookingHistory = React.lazy(() =>
	import('module/booking/BookingHistory')
);
const MovieManage = React.lazy(() => import('module/movie/MovieManage'));
const MovieDetailTmdb = React.lazy(() =>
	import('pages/MovieDetail/MovieDetailTmdb')
);
...
const ShowtimeManage = React.lazy(() =>
	import('module/showtime/ShowtimeManage')
);
const ShowtimeAddNew = React.lazy(() =>
	import('module/showtime/ShowtimeAddNew')
);
const ShowtimeUpdate = React.lazy(() =>
	import('module/showtime/ShowtimeUpdate')
);
const ShowtimeView = React.lazy(() => import('module/showtime/ShowtimeView'));
const ComplexesManage = React.lazy(() =>
	import('module/cinema/ComplexesManage')
);
				...
				<Routes>
					...
					<Route element={<ProtectedRoutes isAllowed={['admin']} />}>
						<Route element={<DashboardLayout />}>
							...
							<Route
								path={`${path.showtimeUpdate}/:id`}
								element={<ShowtimeUpdate />}
							/>
							<Route
								path={`${path.showtimeView}/:id`}
								element={<ShowtimeView />}
							/>
						</Route>
					</Route>
